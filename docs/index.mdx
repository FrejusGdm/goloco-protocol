...
<CardGroup cols={2}>
  <Card title="API" href="/api-reference/introduction" icon="server">
    The versioned REST surface at `https://api.1849.ai` (since 2026-09-16; before that the pilot ran at `https://pqaacpyjwv.us-east-2.awsapprunner.com`). Every other client is built on it.
  </Card>
